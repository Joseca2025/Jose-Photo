<div>
    ...
    <button wire:click="$set('open', true)"
        class="font-bold bg-gray-600 transition-colors transition duration-500 hover:scale-105 text-white  px-10 py-2 transition-colors transition duration-500 hover:scale-105">
        Datos
    </button>

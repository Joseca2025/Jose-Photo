...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #4c3824 0%, #fad584 100%);
        }
    </style>
    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            <div class="pl-4 flex items-center">
                <img src="{{ asset('icono/foto.jpg') }}" style="height: 50px; width: 50px;" alt="">
                <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl ml-5"
                    href="#">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20 "
                id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center mb-5">
                    <li class="mr-3">
                ...
                <a id="navAction" href="{{ route('logout') }}" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        ...
        <div class="container mx-auto px-8">
            <div class="w-full flex flex-col md:flex-row py-6">
                <div class="flex-1 mb-6 text-black">
                    <a class="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-3xl"
                        href="#">
                        <!--Icon from: http://www.potlabicons.com/ -->
                        <svg class="h-8 fill-current inline" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <rect width="20.5" height="20.5" x="4.75" y="4.75" stroke="#0A0A30"
                                stroke-width="1.5" rx="4.25" />
                            <rect width="6" height="6" x="12" y="12" stroke="#265BFF"
                                stroke-width="1.5" rx="3"
                                style="animation:instagram 2s linear infinite both;transform-origin:center center" />
    ...
    <script>
        ...
        document.addEventListener("scroll", function() {
            ...
            if (scrollpos > 10) {
                ...
                navaction.classList.add("bg-yellow-800");
                ...
                navaction.classList.remove("bg-yellow-800");
